...
const totalMovies = 1000; // Total number of fake movies
...
//
//
//script movie table wroks but not moviegenre
//
//
// import { faker } from "@faker-js/faker";
// import sequelize, { Genre, Movie, MovieGenre } from "./database";
...
// import { MovieGenreAttributes } from "../models/MovieGenre";
...
//     for (let i = 0; i < totalMovies; i += chunkSize) {
//       const moviesData: MovieAttributes[] = [];
//       const movieGenreData: MovieGenreAttributes[] = [];
...
//         for (const genre of randomGenres) {
//           movieGenreData.push({
//             movieID: i + j + 1, // This assumes auto-increment starts at 1
//             genreID: genre.genreID,
//           });
//         }
...
//             type: movie.type,
//             certificate: movie.certificate,
//             genres: randomGenres.map((genre: any) => genre.genreName),
//             createdAt: new Date().toISOString(),
//           }
//         );
//       }

//       // Insert movies and genre data into the database
...
//             certificate: movie.certificate,
//             genres: movie.Genres
//               ? movie.Genres.map((genre: any) => genre.genreName)
//               : [],
...
//         if (body.length) {
//           const bulkResponse = await esClient.bulk({
//             refresh: true, // Ensure data is immediately searchable after the operation
//             body,
//           });
...
//             console.error("Failed documents:", erroredDocuments);
//           } else {
//             console.log(`Inserted/updated ${movies.length} movies.`);
//           }

//           // Manually refresh the index to ensure all data is available
//           await esClient.indices.refresh({ index: "movies" });
//         }

//         console.log(
//           `Indexed ${movies.length} movies. Total progress: ${
