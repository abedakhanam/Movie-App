...
//   const fetchcallbackMovies = useCallback(() => {
//     fetchMovies(page, limit, filters);
...
//       fetchMovies(page, limit, filters);
//     }
//   }, [fetchMovies, loading, hasMore, page, limit, filters]);

//   // Initial fetch of movies when the component mounts
//   useEffect(() => {
//     dispatch(resetMovies());
//     fetchMovies(1, limit, filters);
//     setInitialLoad(false);
//   }, [dispatch, fetchMovies, initialLoad, limit, filters, searchQuery]);

//   // Scroll event listener
//   useEffect(() => {
//     window.addEventListener("scroll", handleScroll);
//     // return () => window.removeEventListener("scroll", handleScroll);
//   }, [loading, hasMore, page]); /// see if it wokrs in main page.
